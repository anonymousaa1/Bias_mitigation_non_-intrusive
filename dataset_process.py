...
class IdentityDetect():
    def __init__(self):
        # term_file_path = "parameters/identity_class.json"
        term_file_path = "parameters/identity_term_replace.json"
        ...
        terms_f2m_path = "parameters/identity_terms_f2m.json"
        terms_m2f_path = "parameters/identity_terms_m2f.json"
